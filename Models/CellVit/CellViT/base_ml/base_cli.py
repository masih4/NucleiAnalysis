...
class ExperimentBaseParser:
    ...
    def __init__(self) -> None:
        ...
        requiredNamed.add_argument(
            "--config", type=str, help="Path to a config file", default='/home/ntorbati/PycharmProjects/NucleiAnalysis/Models/CellVit/CellViT/configs/examples/cell_segmentation/train_cellvit.yaml',
        )
