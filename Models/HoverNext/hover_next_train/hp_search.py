...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config",
        type=str,
        default='/home/ntorbati/PycharmProjects/NucleiAnalysis/Models/HoverNext/hover_next_train/sample_configs/train_pannuke.toml',
    ...
    nclasses = 1# if params["dataset"] == "pannuke" else 7
